...
export const FLEET: TruckFleet[] = [
  ...
  },
  {
    ...
    model: "/3dmodel/loggingtruck.glb",
    sketchfab: "",
    payload: "50,000 lb",
    payloadKg: "22,700 kg",
    loadHeight: "10 ft",
    ...
    width: "8 ft 6 in",
    description:
      "Open-deck log trucks for timber and forestry hauling — loaded by crane or log loader, bound down to spec and tracked on every mile from forest landing to mill yard.",
    highlights: [
      "Reinforced stanchions and log bunks",
      "DOT-spec oversized load permits",
      "Chains, binders and tarping included",
    ],
  },
  {
    id: "step-deck",
